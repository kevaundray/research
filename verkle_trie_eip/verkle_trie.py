...
if __name__ == "__main__":
    ...
    # Build an empty verkle trie
    root_node = {"node_type": VERKLE_TRIE_NODE_TYPE_INNER}

    # We want to make a proof of absence of this key
    key_threes = bytes([3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
                        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3])

    verkle_add_missing_commitments(root_node)

    keys_in_proof = [key_threes]
    values_in_proof = [None]

    proof = make_verkle_proof(root_node, keys_in_proof)

    _, update_hint = check_verkle_proof(
